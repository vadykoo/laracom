...
@section('content')
    ...
    @if($cat1->products->isNotEmpty())
        <section class="new-product t100 home">
            <div class="container">
                ...
                <div id="browse-all-btn"> <a class="btn btn-default browse-all-btn" href="{{ route('front.category.slug', $cat1->slug) }}" role="button">{{__("browse all items")}}</a></div>
            </div>
        </section>
    @endif
    <hr>
    @if($cat2->products->isNotEmpty())
        <div class="container">
            ...
            <div id="browse-all-btn"> <a class="btn btn-default browse-all-btn" href="{{ route('front.category.slug', $cat2->slug) }}" role="button">{{__("browse all items")}}</a></div>
        </div>
    @endif
    <hr />
